import { Balance, BALANCE_COLUMNS, BALANCE_FORM_COLUMNS, BALANCE_ID_FIELD, BALANCE_PAGE_TITLE, BALANCE_TABLE_NAME, BUYOUT_PAGE_TITLE, CARGO_PAGE_TITLE, CLIENT_PAGE_TITLE, CORRECTION_PAGE_TITLE, EMPLOYEE_PAGE_DESCRIPTION, NormalizedRate, OPERATION_CARD_PAGE_TITLE, OPERATION_SAFE_PAGE_TITLE, ORDER_PAGE_TITLE, POSITION_PAGE_TITLE, Rate, RATE_COLUMNS, RATE_FORM_COLUMNS, RATE_ID_FIELD, RATE_TABLE_NAME, TORG12_PAGE_TITLE } from "@/entities";
...
export const BASE_PAGES = [
    {
        path: '/positions',
        element: <PageLayout title={POSITION_PAGE_TITLE}>
      <CrudTable<Position>
    ...
    {
          path: '/employers',
    element: <PageLayout title={EMPLOYEE_PAGE_DESCRIPTION}>
      <EmployerTable />
    </PageLayout>,
    },
    {
  ...
  {
    path: '/balance',
    element: <PageLayout title={"Баланс"}>
  ...
  },
  {
    ...
    element: <PageLayout title={OPERATION_CARD_PAGE_TITLE}>
      <OperationCardTable />
    </PageLayout>,
  },
   {
    path: '/clients',
    element: <PageLayout title={CLIENT_PAGE_TITLE}>
     <ClientTable />
    </PageLayout>,
  },
  {
    path: '/orders',
    element: <PageLayout title={ORDER_PAGE_TITLE}>
      <OrderTable />
    </PageLayout>,
  },
   {
    path: '/cargos',
    element: <PageLayout title={CARGO_PAGE_TITLE}>
      <CargoTable />
    </PageLayout>,
  },
  {
    path: '/buyouts',
    element: <PageLayout title={BUYOUT_PAGE_TITLE}>
      <BuyoutTable />
    </PageLayout>,
  },
  {
    path: '/torg12s',
    element: <PageLayout title={TORG12_PAGE_TITLE}>
      <Torg12Table />
    </PageLayout>,
  },
  {
    path: '/corrections',
    element: <PageLayout title={CORRECTION_PAGE_TITLE}>
      <CorrectionTable />
    </PageLayout>,
  },
   {
